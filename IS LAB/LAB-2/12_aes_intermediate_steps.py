"""12. aes_intermediate_steps

Modify AES to display key expansion/round keys, initial AddRoundKey,
SubBytes, ShiftRows, MixColumns, AddRoundKey, main rounds and final round;
...
def main():
    ...
    print("========== AES-192 INTERMEDIATE STEPS ==========")

    key_input = input(
        "Enter 48-character hexadecimal key: "
    ).strip()
    ...
    try:
        ...
        if len(key) != 24:
            print("Key must be exactly 24 bytes (48 hex characters).")
            return
