"""Question 6: Rabin basic encryption decryption

Generate Rabin keys using primes p,q congruent to 3 mod 4; encrypt a message, decrypt with CRT and display all four roots.
"""
...
def main():
    print("==============================")
    print("RABIN BASIC ENCRYPTION/DECRYPTION")
    print("==============================")
    print()
    keys = rabin_keygen()
    plaintext = 123
